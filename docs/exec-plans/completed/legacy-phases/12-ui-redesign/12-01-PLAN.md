...
@docs/exec-plans/completed/legacy-phases/12-ui-redesign/12-RESEARCH.md
@docs/exec-plans/completed/legacy-phases/12-ui-redesign/CONTEXT.md
@frontend/src/features/scenario-builder/components/scenario-builder.tsx
...
<output>
완료 후, `docs/exec-plans/completed/legacy-phases/12-ui-redesign/12-01-SUMMARY.md` 생성
</output>
