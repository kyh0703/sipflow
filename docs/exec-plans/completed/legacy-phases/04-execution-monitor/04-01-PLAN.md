...
@docs/exec-plans/completed/legacy-phases/03-sip-engine/03-05-SUMMARY.md
...
<output>
완료 후, `docs/exec-plans/completed/legacy-phases/04-execution-monitor/04-01-SUMMARY.md` 생성
</output>
