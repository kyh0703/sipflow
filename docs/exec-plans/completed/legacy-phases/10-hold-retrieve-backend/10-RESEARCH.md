...
- `docs/design-docs/research/v1.2-transfer-hold-ui/summary.md` — v1.2 사전 연구 요약 (버그 #110, #125, PR #126 현황)
- `docs/design-docs/research/v1.2-transfer-hold-ui/architecture.md` — 설계 코드 예시 (구현 가이드)
