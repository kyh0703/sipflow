...
@docs/exec-plans/completed/legacy-phases/10-hold-retrieve-backend/10-RESEARCH.md
@docs/exec-plans/completed/legacy-phases/10-hold-retrieve-backend/10-01-SUMMARY.md
@internal/engine/executor.go
@internal/engine/executor_test.go
</context>
...
<output>
완료 후, `docs/exec-plans/completed/legacy-phases/10-hold-retrieve-backend/10-02-SUMMARY.md` 생성
</output>
