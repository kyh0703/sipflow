...
@docs/exec-plans/completed/legacy-phases/13-new-node-ui-integration-quality/13-RESEARCH.md
@internal/engine/graph_test.go
...
<output>
완료 후, `docs/exec-plans/completed/legacy-phases/13-new-node-ui-integration-quality/13-02-SUMMARY.md` 생성
</output>
