...
- `docs/exec-plans/completed/legacy-phases/11-blindtransfer-backend/CONTEXT.md` — 사용자 결정사항 (결정 섹션)
- `docs/exec-plans/completed/legacy-phases/10-hold-retrieve-backend/10-RESEARCH.md` — Phase 10 연구 (reInviter 패턴)
- `docs/project/state.md` — 프로젝트 설계 결정 누적
