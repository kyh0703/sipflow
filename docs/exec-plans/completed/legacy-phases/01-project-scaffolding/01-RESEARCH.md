...
- `docs/design-docs/research/v1.2-transfer-hold-ui/summary.md` - Initial domain research (Wails, diago, XYFlow)
- `docs/design-docs/research/libraries/xyflow-react-flow.md` - Detailed XYFlow v12 patterns
