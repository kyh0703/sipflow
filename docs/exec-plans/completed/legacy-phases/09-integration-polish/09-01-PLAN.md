...
@docs/exec-plans/completed/legacy-phases/09-integration-polish/09-RESEARCH.md
...
<output>
완료 후, `docs/exec-plans/completed/legacy-phases/09-integration-polish/09-01-SUMMARY.md` 생성
</output>
