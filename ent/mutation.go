...
// SIPServerMutation represents an operation that mutates the SIPServer nodes in the graph.
type SIPServerMutation struct {
	config
	op            Op
	typ           string
	id            *int
	...
	oldValue      func(context.Context) (*SIPServer, error)
	predicates    []predicate.SIPServer
}

var _ ent.Mutation = (*SIPServerMutation)(nil)

// sipserverOption allows management of the mutation configuration using functional options.
type sipserverOption func(*SIPServerMutation)

// newSIPServerMutation creates new mutation for the SIPServer entity.
func newSIPServerMutation(c config, op Op, opts ...sipserverOption) *SIPServerMutation {
	m := &SIPServerMutation{
		config:        c,
		op:            op,
		typ:           TypeSIPServer,
...
// withSIPServerID sets the ID field of the mutation.
func withSIPServerID(id int) sipserverOption {
	return func(m *SIPServerMutation) {
		var (
			err   error
			once  sync.Once
			value *SIPServer
		)
		m.oldValue = func(ctx context.Context) (*SIPServer, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().SIPServer.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withSIPServer sets the old SIPServer of the mutation.
func withSIPServer(node *SIPServer) sipserverOption {
	return func(m *SIPServerMutation) {
		m.oldValue = func(context.Context) (*SIPServer, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m SIPServerMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m SIPServerMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *SIPServerMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *SIPServerMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().SIPServer.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetName sets the "name" field.
func (m *SIPServerMutation) SetName(s string) {
	m.name = &s
}

// Name returns the value of the "name" field in the mutation.
func (m *SIPServerMutation) Name() (r string, exists bool) {
	v := m.name
	if v == nil {
		return
	}
...
// OldName returns the old "name" field's value of the SIPServer entity.
// If the SIPServer object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SIPServerMutation) OldName(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldName is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetName resets all changes to the "name" field.
func (m *SIPServerMutation) ResetName() {
	m.name = nil
}

// SetAddress sets the "address" field.
func (m *SIPServerMutation) SetAddress(s string) {
	m.address = &s
}

// Address returns the value of the "address" field in the mutation.
func (m *SIPServerMutation) Address() (r string, exists bool) {
	v := m.address
	if v == nil {
		return
	}
...
// OldAddress returns the old "address" field's value of the SIPServer entity.
// If the SIPServer object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SIPServerMutation) OldAddress(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SIPServerMutation) ResetAddress() {
	m.address = nil
}

// SetPort sets the "port" field.
func (m *SIPServerMutation) SetPort(i int) {
	m.port = &i
	m.addport = nil
}

// Port returns the value of the "port" field in the mutation.
func (m *SIPServerMutation) Port() (r int, exists bool) {
	v := m.port
	if v == nil {
		return
	}
...
// OldPort returns the old "port" field's value of the SIPServer entity.
// If the SIPServer object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SIPServerMutation) OldPort(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SIPServerMutation) AddPort(i int) {
	if m.addport != nil {
		*m.addport += i
	} else {
		m.addport = &i
...
func (m *SIPServerMutation) AddedPort() (r int, exists bool) {
	v := m.addport
	if v == nil {
		return
	}
...
func (m *SIPServerMutation) ResetPort() {
	m.port = nil
	m.addport = nil
}

// SetTransport sets the "transport" field.
func (m *SIPServerMutation) SetTransport(s string) {
	m.transport = &s
}

// Transport returns the value of the "transport" field in the mutation.
func (m *SIPServerMutation) Transport() (r string, exists bool) {
	v := m.transport
	if v == nil {
		return
	}
...
// OldTransport returns the old "transport" field's value of the SIPServer entity.
// If the SIPServer object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SIPServerMutation) OldTransport(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SIPServerMutation) ResetTransport() {
	m.transport = nil
}

// SetUsername sets the "username" field.
func (m *SIPServerMutation) SetUsername(s string) {
	m.username = &s
}

// Username returns the value of the "username" field in the mutation.
func (m *SIPServerMutation) Username() (r string, exists bool) {
	v := m.username
	if v == nil {
		return
	}
...
// OldUsername returns the old "username" field's value of the SIPServer entity.
// If the SIPServer object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SIPServerMutation) OldUsername(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SIPServerMutation) ClearUsername() {
	m.username = nil
	m.clearedFields[sipserver.FieldUsername] = struct{}{}
}

// UsernameCleared returns if the "username" field was cleared in this mutation.
func (m *SIPServerMutation) UsernameCleared() bool {
	_, ok := m.clearedFields[sipserver.FieldUsername]
	return ok
}

// ResetUsername resets all changes to the "username" field.
func (m *SIPServerMutation) ResetUsername() {
	m.username = nil
	delete(m.clearedFields, sipserver.FieldUsername)
}

// SetPassword sets the "password" field.
func (m *SIPServerMutation) SetPassword(s string) {
	m.password = &s
}

// Password returns the value of the "password" field in the mutation.
func (m *SIPServerMutation) Password() (r string, exists bool) {
	v := m.password
	if v == nil {
		return
	}
...
// OldPassword returns the old "password" field's value of the SIPServer entity.
// If the SIPServer object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SIPServerMutation) OldPassword(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SIPServerMutation) ClearPassword() {
	m.password = nil
	m.clearedFields[sipserver.FieldPassword] = struct{}{}
}

// PasswordCleared returns if the "password" field was cleared in this mutation.
func (m *SIPServerMutation) PasswordCleared() bool {
	_, ok := m.clearedFields[sipserver.FieldPassword]
	return ok
}

// ResetPassword resets all changes to the "password" field.
func (m *SIPServerMutation) ResetPassword() {
	m.password = nil
	delete(m.clearedFields, sipserver.FieldPassword)
}

// SetCreatedAt sets the "created_at" field.
func (m *SIPServerMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *SIPServerMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the SIPServer entity.
// If the SIPServer object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SIPServerMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreatedAt resets all changes to the "created_at" field.
func (m *SIPServerMutation) ResetCreatedAt() {
	m.created_at = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *SIPServerMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *SIPServerMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the SIPServer entity.
// If the SIPServer object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SIPServerMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUpdatedAt resets all changes to the "updated_at" field.
func (m *SIPServerMutation) ResetUpdatedAt() {
	m.updated_at = nil
}

// Where appends a list predicates to the SIPServerMutation builder.
func (m *SIPServerMutation) Where(ps ...predicate.SIPServer) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the SIPServerMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *SIPServerMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.SIPServer, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *SIPServerMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *SIPServerMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (SIPServer).
func (m *SIPServerMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *SIPServerMutation) Fields() []string {
	fields := make([]string, 0, 8)
	if m.name != nil {
		fields = append(fields, sipserver.FieldName)
	}
	if m.address != nil {
		fields = append(fields, sipserver.FieldAddress)
	}
	if m.port != nil {
		fields = append(fields, sipserver.FieldPort)
	}
	if m.transport != nil {
		fields = append(fields, sipserver.FieldTransport)
	}
	if m.username != nil {
		fields = append(fields, sipserver.FieldUsername)
	}
	if m.password != nil {
		fields = append(fields, sipserver.FieldPassword)
	}
	if m.created_at != nil {
		fields = append(fields, sipserver.FieldCreatedAt)
	}
	if m.updated_at != nil {
		fields = append(fields, sipserver.FieldUpdatedAt)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *SIPServerMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *SIPServerMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case sipserver.FieldName:
		return m.OldName(ctx)
	case sipserver.FieldAddress:
	...
	return nil, fmt.Errorf("unknown SIPServer field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *SIPServerMutation) SetField(name string, value ent.Value) error {
	switch name {
	case sipserver.FieldName:
		v, ok := value.(string)
		if !ok {
	...
	return fmt.Errorf("unknown SIPServer field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *SIPServerMutation) AddedFields() []string {
	var fields []string
	if m.addport != nil {
		fields = append(fields, sipserver.FieldPort)
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *SIPServerMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case sipserver.FieldPort:
		return m.AddedPort()
	}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *SIPServerMutation) AddField(name string, value ent.Value) error {
	switch name {
	case sipserver.FieldPort:
		v, ok := value.(int)
		if !ok {
	...
	return fmt.Errorf("unknown SIPServer numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *SIPServerMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(sipserver.FieldUsername) {
		fields = append(fields, sipserver.FieldUsername)
	}
	if m.FieldCleared(sipserver.FieldPassword) {
		fields = append(fields, sipserver.FieldPassword)
	}
	return fields
}
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *SIPServerMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *SIPServerMutation) ClearField(name string) error {
	switch name {
	case sipserver.FieldUsername:
		m.ClearUsername()
		return nil
	...
	return fmt.Errorf("unknown SIPServer nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *SIPServerMutation) ResetField(name string) error {
	switch name {
	case sipserver.FieldName:
		m.ResetName()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *SIPServerMutation) AddedEdges() []string {
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *SIPServerMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *SIPServerMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *SIPServerMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *SIPServerMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *SIPServerMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *SIPServerMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown SIPServer unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *SIPServerMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown SIPServer edge %s", name)
}
